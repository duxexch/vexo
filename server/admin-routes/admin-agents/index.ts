    ...
    async (req: AdminRequest, res: Response) => {
      try {
        ...
        const created = await db.transaction(async (tx) => {
          ...
          // Create wallets for every allowed currency, seed defaultCurrency with initial deposit.
...
// Re-export for awareness when a route file becomes empty after refactors
