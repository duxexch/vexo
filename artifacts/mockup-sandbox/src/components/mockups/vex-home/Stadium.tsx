...
const HERO_IMG = "/__mockup/images/vex-home-stadium-hero.png";
const FIFA_IMG = "/__mockup/images/vex-home-stadium-fifa.png";
const CS2_IMG = "/__mockup/images/vex-home-stadium-cs2.png";
const PUBG_IMG = "/__mockup/images/vex-home-stadium-pubg.png";
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <span className="text-xs text-slate-400">@khaled.vx</span>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-2">
          ...
          <div className="col-span-2 md:col-span-1 rounded-lg border border-white/10 bg-white/[0.03] p-2.5">
            ...
            <div className="text-[10px] text-slate-500 mt-1">
              3,400 / 5,000 لرتبة <span className="text-[#ffb627] font-bold">ماسي I</span>
            </div>
          </div>
        </div>

        <div className="flex items-center gap-2">
          <Button className="h-11 px-4 bg-gradient-to-l from-[#1e88ff] to-[#0a4d9c] text-white font-bold rounded-md shadow-[0_6px_25px_-5px_rgba(30,136,255,0.7)] hover:brightness-110">
