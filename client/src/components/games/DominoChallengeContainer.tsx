...
export function DominoChallengeContainer({
    ...
    return (
        <div className="relative w-full max-w-5xl mx-auto overflow-hidden rounded-2xl border border-border/60 bg-[radial-gradient(circle_at_18%_20%,rgba(255,255,255,0.55),transparent_50%),radial-gradient(circle_at_85%_82%,rgba(59,130,246,0.08),transparent_52%),linear-gradient(175deg,rgba(255,255,255,0.35),rgba(15,23,42,0.06))] p-2.5 sm:p-3.5 shadow-[0_22px_40px_rgba(15,23,42,0.16)]">
